...
public class Vehicle implements Comparable<Vehicle> {
  ...
  /**
   * @effects 
   *  return result of comparing this.name and o.name
   */
  @Override
  ...
  public static int compareByNameAsc(Vehicle v1, Vehicle v2) {
    return v1.getName().compareTo(v2.getName());
  }
  
  // DESC (reversed natural) ordering
  public static int compareByNameDesc(Vehicle v1, Vehicle v2) {
